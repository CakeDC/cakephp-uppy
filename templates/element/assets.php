...
echo $this->Html->scriptBlock(sprintf('let csrfToken = %s;', json_encode($this->getRequest()->getAttribute('csrfToken'))));
echo $this->Html->scriptBlock(sprintf('let signUrl = "%s";', $this->Url->build(['prefix' => false, 'plugin' => 'CakeDC/Uppy', 'controller' => 'Files', 'action' => 'sign'])));
echo $this->Html->scriptBlock(sprintf('let saveUrl = "%s";', $this->Url->build(['prefix' => false, 'plugin' => 'CakeDC/Uppy', 'controller' => 'Files', 'action' => 'save'])));
